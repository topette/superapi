...
export const HeroPage = () => {
  ...
  return (
    ...
    <div
      key={getHeroes.id}
      className="w-1/1 sm:1/2 grid sm:grid-cols-2 rounded-2xl shadow-2xl bg-gray-900 m-8"
    >
      ...
      <div className='px-6 py-4'>
        ...
        <p className='inline-block bg-gray-200 rounded-full px-3 py-1 text-sm text-gray-700 mb-2 ml-4 font-semibold'>{getHeroes.poderes}</p>
